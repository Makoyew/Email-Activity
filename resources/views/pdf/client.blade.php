...
<body>
    <div class="container">
        <div class="address">
            <img src="{{public_path('images/tree.jpg')}}" class="logo" alt="Logo">
            <h6 class="text-center">MDC Bank Inc.</h6>
            <p>Tinangnan</p>
            <p>Bohol, Tubigon</p>
        ...
        <p><strong>Name:</strong> {{$client->first_name}} {{$client->middle_name}} {{$client->last_name}}</p>
        <p><strong>Address:</strong> {{$client->address}}</p>
        <p><strong>Phone No.:</strong> {{$client->phone_number}}</p>
